...
<head>
    ...
    <style type="text/css">
        ...
        /*a:link{background-color: #0C0C0C}*/
        /*a:visited{background-color: #0C0C0C}*/
        /*a:hover{background-color: #0C0C0C}*/
    </style>
...
<%--    <h1><a href="/" title="欢迎您光临本站！" >${options.optionSiteTitle}</a></h1>--%>
    <%
         String userName = "";
         String userPass = "";
         //获取当前站点的所有Cookie
    ...
    <form name="loginForm" id="loginForm"  method="post">
        <p>
            <label for="userNameOrEmail">用户名或电子邮件地址<br />
                <input type="text" name="userNameOrEmail" id="userNameOrEmail" class="input" value="<%=userName%>" size="20" required/></label>
        </p>
        <p>
            <label for="user_pass">密码<br />
                <input type="password" name="password" id="user_pass" class="input" value="<%=userPass%>" size="20" required/>
            </label>
        </p>
    ...
    <p id="backtoblog"><a href="/">&larr; 返回到myAll博客</a> | <a href="/register">还没有账号? 注册</a></p>
